"""
Django settings for k8single project.
...
SECRET_KEY = 'django-insecure-r1j=dh&h%madc7wqxg3%56akz1_a56vp)ni4a8e%+_e1az*d5y'
...
WSGI_APPLICATION = 'k8single.wsgi.application'
